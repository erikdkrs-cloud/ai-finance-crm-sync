...
const QUICK_PROMPTS = [
  ...
  { icon: "🎯", label: "Оптимизация", prompt: "Где сократить расходы? Анализ структуры: ЗП, реклама, транспорт, штрафы." },
];
...
const TOOL_PROMPTS = {
  summary: "Краткая сводка: ключевые показатели, топ проекты, риски, рекомендация.",
  compare: "Сравни все доступные периоды между собой: динамика выручки, расходов, прибыли, маржи по месяцам.",
  forecast: "Прогноз на следующий месяц с учётом трендов по каждому проекту.",
  structure: "Покажи структуру расходов по каждому проекту: ЗП подработчиков, менеджеров, руководителей, реклама, транспорт, штрафы, налоги.",
};
...
export default function AssistantPage() {
  ...
  /* ---- Send voice message (short answer + auto-speak) ---- */
      ...
      <div className={`assistant-page ${mounted ? "mounted" : ""}`}>
        ...
        <div className="assistant-hero glass-card">
          ...
          <div className="assistant-hero-text">
            ...
            <p>Голос Onyx • Whisper распознавание • Все устройства и браузеры</p>
          </div>
        </div>
        ...
        <div className="assistant-controls glass-card">
          <div className="assistant-controls-left">
            ...
            <div className="assistant-status-badges">
              ...
              {tokens > 0 && (
                <span className="assistant-status-badge idle">
          ...
          <div className="assistant-widget-header">
            <div>
              ...
              <div className="assistant-widget-subtitle">
                {messages.length} сообщений • {month || "все периоды"} • 🎙️ Голос → короткий ответ +
                озвучка
              </div>
            </div>
            <button
              ...
              {messages.length === 0 && !loading ? (
                <div className="assistant-chat-empty">
                  ...
                  <div className="empty-title">
                    Добрый день, сэр. J.A.R.V.I.S. к вашим услугам.
                  </div>
                  <div className="empty-desc">
                    Текст → развёрнутый ответ • 🎙️ Голос → быстрый ответ + озвучка
                  </div>
                </div>
              ) : (
                messages.map((m, i) => (
