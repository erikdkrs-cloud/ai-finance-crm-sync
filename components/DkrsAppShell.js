...
var DkrsAppShell = function (props) {
  ...
  useEffect(function () {
    var isPortalPage = router.pathname.startsWith("/portal");
    if (isPortalPage) setPortalOpen(true);
  }, [router.pathname]);
                  ...
                  return (
                    <li key={link.href}>
                      <Link href={link.href} style={{
                        ...
                        borderRadius: 8,
                        color: isActive ? "var(--sidebar-active-color, #60a5fa)" : "var(--sidebar-color, rgba(255,255,255,0.6))",
                        background: isActive ? "var(--sidebar-active-bg, rgba(59,130,246,0.1))" : "transparent",
                        textDecoration: "none",
                        fontSize: 13,
